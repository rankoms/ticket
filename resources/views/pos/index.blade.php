            ...
            <section class="">
                <div class="row dashboard">
                    <form id="form-pos">
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-12 col-12 position-relative">
                                <input type="text" name="no_hp" id="no_hp" placeholder="Masukan No HP"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-12 col-12 position-relative">
                                <input type="text" name="club" id="club" placeholder="Masukan Asal Club"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-lg-12 col-12 position-relative">
                                <input type="text" name="type_motor" id="type_motor" placeholder="Masukan Type Motor"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-lg-12 col-12 position-relative">
                                <input type="text" name="no_start" id="no_start" placeholder="Masukan No Start"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="row mb-4">
